...
const TableCell = React.forwardRef<HTMLTableCellElement, React.TdHTMLAttributes<HTMLTableCellElement>>(({ className, ...props }, ref) => <td ref={ref} className={cn("p-4 py-6 align-middle [&:has([role=checkbox])]:pr-0", className)} {...props} />);
